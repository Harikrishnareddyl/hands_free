...
<p align="center">
  <a href="https://github.com/Harikrishnareddyl/hands-free/releases"><img alt="Latest release" src="https://img.shields.io/github/v/release/Harikrishnareddyl/hands-free?sort=semver" /></a>
...
```bash
curl -fsSL https://raw.githubusercontent.com/Harikrishnareddyl/hands-free/main/install.sh | bash
```
...
1. Download the latest **`HandsFree-X.Y.Z.dmg`** from the [Releases](https://github.com/Harikrishnareddyl/hands-free/releases) page.
...
```bash
git clone https://github.com/Harikrishnareddyl/hands-free.git
cd hands-free
